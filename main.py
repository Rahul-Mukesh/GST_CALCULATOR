...
#Configuration Key
firebaseConfig = {
    'apiKey': "AIzaSyAa7nWG4vlKyrjyeqlse3rALK0LCUR5VQg",
    'authDomain': "gst-calculator-15dcc.firebaseapp.com",
    'projectId': "gst-calculator-15dcc",
    'databaseURL':"https://gst-calculator-15dcc-default-rtdb.europe-west1.firebasedatabase.app/",
    'storageBucket': "gst-calculator-15dcc.appspot.com",
    'messagingSenderId': "564744988958",
    'appId': "1:564744988958:web:7ad53020d6ab6ea933c10f",
    'measurementId': "G-NCQ7V46T5L"
  };
...
if choice == 'Login':
    ...
    if login:
        if __name__ == '__main__':
            ...
            # SETTINGS PAGE
            if bio == 'Settings':
                language_choice = st.selectbox('Select Language of the App',
                                                       options=['English(Default)','Kannada', 'Telugu', 'Marathi', 'Tamil'])
                ...
                if inbio == 'Exclusive':
                    ...
                    if calculate:
                        if amount and gst_rate:
                            ...
                            output.text(
                                f'The GST amount is: {gst_amount:.2f} and the total amount is: {total_amount:.2f}')
                        else:
                ...
                if inbio == 'Inclusive':
                    ...
                    if calculate:
                        if amount and gst_rate:
                            ...
                            output.text(
                                f'The base amount is: {base_amount:.2f} and the GST amount is: {gst_amount:.2f}')
                        else:
                            st.warning("Please enter both the amount and the GST rate.")
            ...
            if bio == 'Chatbot':
                st.title('Welcome to GST Chat Assistence')
